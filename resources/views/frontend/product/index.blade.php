...
@section('content')
    <!-- =============== TENDING PAGE BANNER STARTS =============== -->

    <div class="page-banner d-flex align-items-end trending-page-banner">
        <div class="container-xl">
            <div class="banner-content-wrapper">
                <div class="banner-content">
                    <h2 class="heading-two fw-700 color-black mb-2">What's In</h2>
                    <p class="text-reg fw-400 color-black">
                        <a class="color-black" href="index.html">Home </a> > Trending
                    </p>
                </div>
            </div>
        </div>
    ...
    <!-- =============== TENDING PAGE BANNER ENDS =============== -->

    <!-- =============== TRENDING GRID STARTS =============== -->

    <div class="trending vertical-padding-top">
        <div class="container-xl">
            <div class="section-top-cta d-flex horizontal-padding-lg">
                <h2 class="heading-two fw-700 color-black">Trending Styles</h2>
                <a
                    href=""
            ...
            <div class="product-grid-item-wrapper d-flex row gy-4">
                <div
                    class="gray-effect-wrapper product-grid-item col-lg-3 col-md-4 col-sm-6"
                >
                    <div class="product-grid-item-thumb position-relative">
                        <a href="styles-single-details.html"
                        ><img
                                class="gray-img"
                                src="{{asset('frontend/images/product-graystyle1.png')}}"
                                alt=""
                            /></a>
                    </div>
                </div>
                ...
                >
                    <div class="product-grid-item-thumb position-relative">
                        ...
                        ><img
                                class="gray-img"
                                src="{{asset('frontend/images/product-graystyle2.png')}}"
                                alt=""
                            /></a>
                    </div>
                </div>
