...
@section('content')
                    ...
                    <div class="hero-featured-block position-relative">
                        <div class="hero-featured-img-wrapper">
                            <img
                                ...
                                src="{{asset('frontend/images/men-hero-featured2.webp')}}"
                                alt=""
                            />
                        </div>
                        <div class="hero-featured-text position-absolute">
                            <h2 class="heading-two color-white mb-4">
                                Best Collection For Men's Products
                            </h2>
                ...
                <div class="col-md-6">
                    <div class="hero-featured-block position-relative">
                        <div class="hero-featured-img-wrapper">
                            <img
                                class="hero-featured-img"
                                src="{{asset('frontend/images/men-hero-featured.webp')}}"
                                alt=""
                            />
                        </div>
                        <div class="hero-featured-text position-absolute">
    ...
    <div class="top-category-slider-area vertical-padding-bottom">
        <div class="container-xl">
                ...
                >
                    <div class="top-category-card men">
                        <div class="top-category-thumb">
                            <img
                                class="gray-img"
                                src="{{asset('frontend/images/top-ctg-1.png')}}"
                                alt=""
                            />
                        </div>
                        <div
                ...
                >
                    <div class="top-category-card men">
                        <div class="top-category-thumb">
                            <img
                                class="gray-img"
                                src="{{asset('frontend/images/top-ctg-2.png')}}"
                                alt=""
                            />
                        </div>
                        <div
                ...
                >
                    <div class="top-category-card men">
                        <div class="top-category-thumb">
                            <img
                                class="gray-img"
                                src="{{asset('frontend/images/top-ctg-3.png')}}"
                                alt=""
                            />
                        </div>
                        <div
                ...
                >
                    <div class="top-category-card men">
                        <div class="top-category-thumb">
                            <img
                                class="gray-img"
                                src="{{asset('frontend/images/top-ctg-4.png')}}"
                                alt=""
                            />
                        </div>
                        <div
    ...
    <div class="product-grid-slider-area men--area">
        <div class="container-xl">
            <div class="section-top-cta d-flex">
            ...
            <div class="swiper productGridSlider product-grid-slider-wrapper">
                ...
                <div
                    class="productgrid-pagination d-flex justify-content-center"
                ></div>
            </div>
        </div>
    </div>
            ...
            <div class="row discount-content-wrapper g-0">
                <div class="col-md-6">
                    <div class="discount-thumb">
                        <img src="frontend/images/men-discount-thumb.jpg" alt="" />
                    </div>
                </div>
                <div class="col-md-6 offwhitelight-bg d-flex align-items-end">
                    <div class="discount-content">
                        <h3 class="color-black">Flat</h3>
                        <h2 class="discount-percentage color-black">
                            <p>25%</p>
                        ...
                        <a href="" class="cs-btn btn-style-one black-bg">Discover More</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="product-grid-slider-area men--area featured-accessorries">
        <div class="container-xl">
            <div class="section-top-cta d-flex">
                  ...
                  >
                    ...
                    >
                      ...
                      />
                            ...
                            <a href="single-product.html"
                            ><img src="{{asset('frontend/images/accessories(1).jpg')}}" alt=""
                                /></a>
                        </div>
                        <div class="product-card-content">
                            <div
                  ...
                  >
                    ...
                    >
                      ...
                      />
                            ...
                            <a href="single-product.html"
                            ><img src="{{asset('frontend/images/accessories(2).jpg')}}" alt=""
                                /></a>
                        </div>
                        <div class="product-card-content">
                            <div
                  ...
                  >
                    ...
                    >
                      ...
                      />
                            ...
                            <a href="single-product.html"
                            ><img src="{{asset('frontend/images/accessories(3).png')}}" alt=""
                                /></a>
                        </div>
                        <div class="product-card-content">
                            <div
                  ...
                  >
                    ...
                    >
                      ...
                      />
                            ...
                            <a href="single-product.html"
                            ><img src="{{asset('frontend/images/accessories.jpg')}}" alt=""
                                /></a>
                        </div>
                        <div class="product-card-content">
                            <div
