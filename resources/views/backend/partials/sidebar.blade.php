            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Tables</span><i
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Charts</span><i
                            class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li class="sub-slide">
                            <a class="sub-side-menu__item" data-bs-toggle="sub-slide"
                               href="#"><span class="sub-side-menu__label">Submenu-2</span><i
                            ...
                            <ul class="sub-slide-menu">
                                ...
                                <li class="sub-slide2">
                                    ...
                                    <ul class="sub-slide-menu2">
                                        <li><a href="#" class="sub-slide-item2">Submenu-2.3.1</a>
                                        </li>
                                        <li><a href="#" class="sub-slide-item2">Submenu-2.3.2</a>
                                        </li>
                                        <li><a href="#" class="sub-slide-item2">Submenu-2.3.3</a>
                                        </li>
                                    </ul>
                                </li>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li class="sub-slide">
                            <a class="sub-side-menu__item" data-bs-toggle="sub-slide"
                               href="#"><span class="sub-side-menu__label">E-Commerce</span><i
                                    class="sub-angle fa fa-angle-right"></i></a>
                            <ul class="sub-slide-menu">
                        ...
                        <li class="sub-slide">
                            <a class="sub-side-menu__item" data-bs-toggle="sub-slide"
                               href="#"><span class="sub-side-menu__label">File Manager</span><i
                                    class="sub-angle fa fa-angle-right"></i></a>
                            <ul class="sub-slide-menu">
                                <li><a class="sub-slide-item" href="file-manager.html">Files</a></li>
                                <li><a class="sub-slide-item" href="file-manager1.html">File Manager</a>
                                </li>
                                <li><a class="sub-slide-item" href="file-manager2.html">File Details</a>
                                </li>
                            </ul>
                        </li>
                        <li class="sub-slide">
                            <a class="sub-side-menu__item" data-bs-toggle="sub-slide"
                               href="#"><span class="sub-side-menu__label">E-Mail</span><i
                                    class="sub-angle fa fa-angle-right"></i></a>
                            <ul class="sub-slide-menu">
                                <li><a class="sub-slide-item" href="mail-inbox.html">Inbox</a></li>
                                <li><a class="sub-slide-item" href="mail-compose.html">Compose Mail</a>
                                </li>
                                <li><a class="sub-slide-item" href="mail-read.html">Read Mail</a></li>
                                <li><a class="sub-slide-item" href="mail-settings.html">Mail
                                        Settings</a></li>
                            </ul>
                        </li>
                        <li class="sub-slide">
                            <a class="sub-side-menu__item" data-bs-toggle="sub-slide"
                               href="#"><span class="sub-side-menu__label">Invoices</span><i
                                    class="sub-angle fa fa-angle-right"></i></a>
                            <ul class="sub-slide-menu">
                                <li><a class="sub-slide-item" href="invoice-list.html">Invoice List</a>
                                </li>
                                <li><a class="sub-slide-item" href="invoice-details.html">Invoice
                                        Details</a></li>
                                <li><a class="sub-slide-item" href="invoice-create.html">Create
                                        Invoice</a></li>
                                <li><a class="sub-slide-item" href="invoice-timelog.html">Time Log
                                        Invoice</a></li>
                                <li><a class="sub-slide-item" href="invoice-edit.html">Edit Invoice</a>
                                </li>
                            </ul>
                        </li>
                        <li class="sub-slide">
                            <a class="sub-side-menu__item" data-bs-toggle="sub-slide"
                               href="#"><span class="sub-side-menu__label">Projects</span><i
                                    class="sub-angle fa fa-angle-right"></i></a>
                            <ul class="sub-slide-menu">
                                <li><a class="sub-slide-item" href="projects.html">Projects</a></li>
                                <li><a class="sub-slide-item" href="projects-list.html">Projects
                                        List</a></li>
                                <li><a class="sub-slide-item" href="project-details.html">Project
                                        Details</a></li>
                                <li><a class="sub-slide-item" href="project-new.html">Project New</a>
                                </li>
                                <li><a class="sub-slide-item" href="project-edit.html">Edit Project</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="sub-slide">
                            <a class="sub-side-menu__item" data-bs-toggle="sub-slide"
                               href="#"><span class="sub-side-menu__label">Tasks</span><i
                                    class="sub-angle fa fa-angle-right"></i></a>
                            <ul class="sub-slide-menu">
                                ...
                                <li><a class="sub-slide-item" href="task-create.html">Create Task</a>
                                </li>
                            </ul>
                        </li>
                        <li class="sub-slide">
                            <a class="sub-side-menu__item" data-bs-toggle="sub-slide"
                               href="#"><span class="sub-side-menu__label">Clients</span><i
                                    class="sub-angle fa fa-angle-right"></i></a>
                            <ul class="sub-slide-menu">
                                <li><a class="sub-slide-item" href="clients.html">Clients</a></li>
                                <li><a class="sub-slide-item" href="client-create.html">Add Client</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">UI Elements</span><i
                            class="angle fa fa-angle-right"></i>
                    </a>
                    <ul class="slide-menu">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li class="sub-slide">
                            ...
                            <ul class="sub-slide-menu">
                                ...
                                <li><a class="sub-slide-item" href="forgot-password.html">Forgot
                                        Password</a></li>
                                <li><a class="sub-slide-item" href="lockscreen.html">Lockscreen</a></li>
                                <li><a class="sub-slide-item"
                                       href="construction.html">UnderConstruction</a></li>
                            </ul>
                        </li>
                        <li class="sub-slide">
                            <a class="sub-side-menu__item" data-bs-toggle="sub-slide"
                               href="#"><span class="sub-side-menu__label">Error Pages</span><i
                                    class="sub-angle fa fa-angle-right"></i></a>
                            <ul class="sub-slide-menu">
                        ...
                        <li class="sub-slide">
                            <a class="sub-side-menu__item" data-bs-toggle="sub-slide"
                               href="#"><span class="sub-side-menu__label">Blog</span><i
                                    class="sub-angle fa fa-angle-right"></i></a>
                            <ul class="sub-slide-menu">
                                <li><a class="sub-slide-item" href="blog.html">Blog</a></li>
                                <li><a class="sub-slide-item" href="blog-details.html">Blog Details</a>
                                </li>
