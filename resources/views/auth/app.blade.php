...
<head>
    ...
    <meta name="keywords" content="davidmoorelooks">
    ...
    <div>
        <div class="col col-login mx-auto text-center">
            <a href="{{ route('dashboard') }}">
                <img src="{{isset($systemSetting->logo) && !empty($systemSetting->logo) ? asset($systemSetting->logo) :  asset('backend/images/brand/logo.png') }}" class="header-brand-img" alt="">
            </a>
        </div>
